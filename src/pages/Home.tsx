...
// Static data — 55+ services (must match seed.ts allServices)
const mainServices = [
  { name: "Halı Saha Yapımı", slug: "hali-saha-yapimi", desc: "Profesyonel halı saha yapımı. FIFA standartlarında 55mm suni çim, çelik konstrüksiyon, LED aydınlatma.", icon: "⚽", color: "from-green-500 to-green-600" },
  { name: "Kapalı Halı Saha Yapımı", slug: "kapali-hali-saha-yapimi", desc: "Branda veya sandwich panel kapalı halı saha yapımı. 4 mevsim kullanım imkanı.", icon: "🏟️", color: "from-blue-500 to-blue-600" },
  { name: "Açık Halı Saha Yapımı", slug: "acik-hali-saha-yapimi", desc: "Açık halı saha yapımı. Ekonomik ve hızlı çözüm. 20x40m, 25x45m, 30x50m ölçüler.", icon: "🌿", color: "from-emerald-500 to-emerald-600" },
  { name: "Basketbol Sahası Yapımı", slug: "basketbol-sahasi-yapimi", desc: "Profesyonel basketbol sahası yapımı. Akrilik zemin, TBF standartlarında pota sistemleri.", icon: "🏀", color: "from-orange-500 to-orange-600" },
  { name: "Tenis Kortu Yapımı", slug: "tenis-kortu-yapimi", desc: "Akrilik ve çim tenis kortu yapımı. ITF standartlarında, profesyonel zemin kaplama.", icon: "🎾", color: "from-yellow-500 to-yellow-600" },
  { name: "Voleybol Sahası Yapımı", slug: "voleybol-sahasi-yapimi", desc: "Profesyonel voleybol sahası yapımı. FIVB standartlarında zemin ve direk sistemleri.", icon: "🏐", color: "from-cyan-500 to-cyan-600" },
  { name: "Çok Amaçlı Saha Yapımı", slug: "cok-amacli-saha-yapimi", desc: "Basketbol, voleybol ve tenis için çok amaçlı spor sahası yapımı.", icon: "🎯", color: "from-purple-500 to-purple-600" },
  { name: "Nizami Futbol Sahası Yapımı", slug: "nizami-futbol-sahasi-yapimi", desc: "Nizami futbol sahası ve tribün yapımı. FIFA standartlarında, 100x70m ölçüler.", icon: "🏆", color: "from-red-500 to-red-600" },
  { name: "Çelik Konstrüksiyon", slug: "celik-konstruksiyon", desc: "Kapalı saha, hangar ve depo çelik konstrüksiyon yapımı. Dayanıklı ve ekonomik.", icon: "🏗️", color: "from-gray-500 to-gray-600" },
  { name: "Akrilik Zemin Kaplama", slug: "akrilik-zemin-kaplama", desc: "Akrilik zemin kaplama uygulaması. Basketbol, tenis ve voleybol sahaları için ideal.", icon: "🎨", color: "from-pink-500 to-pink-600" },
  { name: "Halı Saha Branda", slug: "hali-saha-branda", desc: "Halı saha branda kaplama ve tamiri. 650gr/m2 PVC branda, UV dayanımlı.", icon: "⛺", color: "from-indigo-500 to-indigo-600" },
  { name: "Suni Çim Saha Kaplama", slug: "suni-cim-saha-kaplama", desc: "55mm sentetik suni çim saha kaplama. FIFA onaylı, 7 yıl garanti.", icon: "🌱", color: "from-teal-500 to-teal-600" },
  { name: "Halı Saha Halısı Satışı", slug: "hali-saha-halisi", desc: "55mm suni çim halı saha halısı satışı. Ten Cate, FIFA standartlarında.", icon: "🧵", color: "from-green-600 to-green-700" },
  { name: "55mm Sentetik Suni Çim Fiyatı", slug: "55mm-suni-cim-fiyati", desc: "55mm sentetik suni çim m2 fiyatları. En kaliteli ürünler, uygun fiyatlar.", icon: "💰", color: "from-amber-500 to-amber-600" },
  { name: "Suni Çim Satan Firmalar", slug: "suni-cim-satan-firmalar", desc: "Suni çim satan firmalar arasında en kaliteli ürünleri en uygun fiyata sunuyoruz.", icon: "🏪", color: "from-violet-500 to-violet-600" },
  { name: "Yapay Çim Satan Yerler", slug: "yapay-cim-satan-yerler", desc: "Yapay çim satan yerler arasında en kaliteli ürün ve hizmet garantisi.", icon: "📍", color: "from-rose-500 to-rose-600" },
  { name: "Halı Saha Yapım Maliyeti", slug: "hali-saha-maliyeti", desc: "2026 güncel halı saha yapım maliyeti. m2 başına fiyatlar ve maliyet hesaplama.", icon: "📊", color: "from-sky-500 to-sky-600" },
  { name: "Açık Halı Saha Maliyeti", slug: "acik-hali-saha-maliyeti", desc: "Açık halı saha yapım maliyeti. Ölçüye göre detaylı fiyatlandırma.", icon: "📈", color: "from-lime-500 to-lime-600" },
  { name: "Kapalı Halı Saha Maliyeti", slug: "kapali-hali-saha-maliyeti", desc: "Kapalı halı saha yapım maliyeti. Branda ve sandwich panel seçenekleri.", icon: "📉", color: "from-fuchsia-500 to-fuchsia-600" },
  { name: "Halı Saha Yapan Firmalar", slug: "hali-saha-yapan-firmalar", desc: "Halı saha yapan firmalar arasında 30 yıllık tecrübemizle öne çıkıyoruz.", icon: "⭐", color: "from-amber-600 to-amber-700" },
  { name: "Kapalı Halı Saha Yapan Firmalar", slug: "kapali-hali-saha-yapan-firmalar", desc: "Kapalı halı saha yapan firmalar arasında lider konumdayız.", icon: "🏢", color: "from-slate-500 to-slate-600" },
  { name: "Açık Halı Saha Yapan Firmalar", slug: "acik-hali-saha-yapan-firmalar", desc: "Açık halı saha yapan firmalar arasında en kaliteli hizmeti sunuyoruz.", icon: "🏕️", color: "from-stone-500 to-stone-600" },
  { name: "Çok Amaçlı Saha Yapan Firmalar", slug: "cok-amacli-saha-yapan-firmalar", desc: "Çok amaçlı saha yapan firmalar arasında profesyonel çözümler.", icon: "🔧", color: "from-zinc-500 to-zinc-600" },
  { name: "Voleybol Sahası Yapan Firmalar", slug: "voleybol-sahasi-yapan-firmalar", desc: "Voleybol sahası yapan firmalar arasında FIVB standartlarında hizmet.", icon: "🥇", color: "from-yellow-600 to-yellow-700" },
  { name: "Tenis Kortu Yapan Firmalar", slug: "tenis-kortu-yapan-firmalar", desc: "Tenis kortu yapan firmalar arasında ITF standartlarında kalite.", icon: "🥈", color: "from-neutral-500 to-neutral-600" },
  { name: "Balon Saha Yapan Firmalar", slug: "balon-saha-yapan-firmalar", desc: "Balon saha yapan firmalar arasında hızlı ve ekonomik çözümler.", icon: "🎈", color: "from-red-400 to-red-500" },
  { name: "Nizami Saha Yapan Firmalar", slug: "nizami-saha-yapan-firmalar", desc: "Nizami futbol sahası yapan firmalar arasında FIFA standartlarında hizmet.", icon: "🏅", color: "from-orange-600 to-orange-700" },
  { name: "Halı Saha Granül Satan Firmalar", slug: "hali-saha-granul-satan-firmalar", desc: "SBR ve EPDM granül satışı. Halı saha zemin dolgu malzemesi.", icon: "⚫", color: "from-gray-600 to-gray-700" },
  { name: "Granül Satan Firmalar", slug: "granul-satan-firmalar", desc: "EPDM ve SBR kauçuk granül satan firmalar. Spor sahaları için ideal.", icon: "🔵", color: "from-blue-600 to-blue-700" },
  { name: "Halı Saha Tavan Filesi", slug: "hali-saha-tavan-filesi", desc: "Halı saha tavan filesi m2 fiyatları. Paraşüt ipi, UV dayanımlı.", icon: "🕸️", color: "from-cyan-600 to-cyan-700" },
  { name: "Halı Saha Filesi Satan Firmalar", slug: "hali-saha-filesi-satan-firmalar", desc: "Halı saha filesi satan firmalar. Tavan, yan ve kale filesi.", icon: "🥅", color: "from-emerald-600 to-emerald-700" },
  { name: "Halı Saha Tamiri", slug: "hali-saha-tamiri", desc: "Halı saha tamiri ve bakım hizmetleri. Zemin düzeltme, çim yenileme.", icon: "🔨", color: "from-amber-700 to-amber-800" },
  { name: "Halı Saha Branda Tamiri", slug: "hali-saha-branda-tamiri", desc: "Halı saha branda tamiri ve değişimi. Yırtık tespiti ve onarım.", icon: "🩹", color: "from-teal-600 to-teal-700" },
  { name: "Suni Çim Tamiri", slug: "suni-cim-tamiri", desc: "Suni çim tamiri ve yenileme hizmetleri. Yıpranmış çim değişimi.", icon: "✂️", color: "from-green-700 to-green-800" },
  { name: "Halı Saha Tel Örgü", slug: "hali-saha-tel-orgu", desc: "Halı saha tel örgü satan firmalar. Galvanizli PVC kaplı tel örgü.", icon: "⛓️", color: "from-zinc-600 to-zinc-700" },
  { name: "Pota Satan Firmalar", slug: "pota-satan-firmalar", desc: "Basketbol potası satan firmalar. TBF onaylı, paslanmaz çelik.", icon: "🪜", color: "from-indigo-600 to-indigo-700" },
  { name: "Tartan Zemin Kaplama", slug: "tartan-zemin-kaplama", desc: "Tartan zemin kaplama yapan firmalar. EPDM kaplamalı spor zeminleri.", icon: "🏃", color: "from-purple-600 to-purple-700" },
  { name: "Padel Kortu Yapımı", slug: "padel-kortu-yapimi", desc: "Padel kortu yapımı. Cam duvar sistemli, profesyonel padel sahaları.", icon: "🥎", color: "from-blue-700 to-blue-800" },
  { name: "Atletizm Pisti Yapımı", slug: "atletizm-pisti-yapimi", desc: "Atletizm pisti yapımı. IAAF standartlarında, tartan zemin.", icon: "🏅", color: "from-red-600 to-red-700" },
  { name: "Havuz Yapımı", slug: "havuz-yapimi", desc: "Olimpik yüzme havuzu yapımı. Betonarme ve prefabrik seçenekler.", icon: "🏊", color: "from-cyan-700 to-cyan-800" },
  { name: "Hibrit Çim Saha Yapımı", slug: "hibrit-cim-saha-yapimi", desc: "Hibrit çim saha yapımı. Doğal çim + suni çim karışımı. FIFA standartlarında.", icon: "🌾", color: "from-lime-600 to-lime-700" },
  { name: "Yedek Kulübesi", slug: "yedek-kulubesi", desc: "Spor sahası yedek kulübesi. Polikarbonat ve akrilik malzeme.", icon: "🪑", color: "from-orange-400 to-orange-500" },
  { name: "Spor Zemin Kaplama", slug: "spor-zemin-kaplama", desc: "Profesyonel spor zemin kaplama hizmetleri. Her türlü spor için.", icon: "🟩", color: "from-green-800 to-green-900" },
  { name: "Basketbol Potaları", slug: "basketbol-potalari", desc: "Profesyonel basketbol potası. TBF onaylı, paslanmaz çelik.", icon: "🏀", color: "from-orange-700 to-orange-800" },
  { name: "Voleybol ve Tenis Direkleri", slug: "voleybol-tenis-direkleri", desc: "Voleybol ve tenis direkleri. Çelik direk, profesyonel file sistemi.", icon: "🎾", color: "from-yellow-700 to-yellow-800" },
  { name: "Futbol Kaleleri", slug: "futbol-kaleleri", desc: "Futbol kalesi ve filesi. Profesyonel standartlarda.", icon: "⚽", color: "from-emerald-700 to-emerald-800" },
  { name: "Tribün Koltukları", slug: "tribun-koltuklari", desc: "Plastik tribün koltuğu. Dayanıklı, ergonomik, renk seçenekleri.", icon: "💺", color: "from-blue-400 to-blue-500" },
  { name: "Halı Saha Skorbord", slug: "hali-saha-skorbord", desc: "Halı saha elektronik skorbord. LED ekran, kumandalı.", icon: "🔢", color: "from-red-700 to-red-800" },
  { name: "Halı Saha Aydınlatma", slug: "hali-saha-aydinlatma", desc: "Halı saha LED aydınlatma sistemi. 200W projektör, homojen ışık.", icon: "💡", color: "from-yellow-400 to-yellow-500" },
  { name: "Prefabrik Konteyner", slug: "prefabrik-konteyner", desc: "Prefabrik konteyner ve çelik ev yapımı. Hızlı kurulum, ekonomik.", icon: "🏠", color: "from-stone-600 to-stone-700" },
];
