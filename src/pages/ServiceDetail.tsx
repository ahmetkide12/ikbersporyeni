...
const allCitiesList = [
  ...
  "Trabzon", "Eskişehir", "Malatya", "Elazığ", "Ordu", "Denizli", "Sivas", "Erzurum",
  "Batman", "Kahramanmaraş", "Muğla", "Mardin", "Afyonkarahisar", "Adıyaman", "Kırıkkale",
  "Osmaniye", "Çorum", "Kütahya", "Isparta", "Aksaray", "Edirne", "Niğde",
];
